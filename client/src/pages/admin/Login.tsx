      ...
      <Card className="max-w-md w-full bg-white rounded-xl shadow-xl overflow-hidden">
        <CardContent className="p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <h2 className="text-2xl font-serif font-bold text-primary-dark">Admin Login</h2>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="admin@booknest.com" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <CardFooter className="px-8 py-4 bg-neutral-50 border-t border-neutral-100 text-center text-sm text-neutral-500">
          <p className="w-full">Contact support for admin account issues</p>
        </CardFooter>
      </Card>
    </div>
  );
